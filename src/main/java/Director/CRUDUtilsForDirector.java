...
public class CRUDUtilsForDirector {
    ...
    private static final String SELECT_ALL_EQUIPMENT_GROUPED_BY_CATEGORY= "SELECT id, serial_number, equipment_name, category, SUM(quantity) FROM SchoolEquipment GROUP BY category";
